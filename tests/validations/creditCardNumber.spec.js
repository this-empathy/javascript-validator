...
describe('Credit Card', () => {
  test('Validates Credit Card Number', () => {
    ...
    valid.forEach(value => expect(validator.creditCardNumber({ name: 'creditCardNumber', value }).valid).toBeTruthy())
    invalid.forEach(value => expect(validator.creditCardNumber({ name: 'creditCardDate', value }).valid).toBeFalsy())
  })
})